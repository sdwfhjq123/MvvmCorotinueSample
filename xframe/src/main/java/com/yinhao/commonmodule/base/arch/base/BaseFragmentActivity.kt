...
abstract class BaseFragmentActivity<M : BaseViewModel, SM : BaseViewModel, B : ViewBinding>
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(bindViewBinding(initViewBinging(layoutInflater), this) {
            dealWithOnCreateViewBond(savedInstanceState, this)
        })
        initWindowFlag()
        setupStatusBar()
        setupFragments()
    ...
    /**
     * ### 处理OnCreateView时savedInstanceState不为空，需处理的相关逻辑
     */
    abstract fun dealWithOnCreateViewBond(savedInstanceState: Bundle?, viewBinding: B)
